...
from server.module import Module, depend
import service.utils.session
import service.connection.httpserver
from utils.http import HttpHandler
from config.config import manager

@depend(service.connection.httpserver.HttpServer, service.utils.session.Session)
