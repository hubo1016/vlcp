...
class CBQueue(object):
    ...
    def canAppend(self):
        ...
        @return: False if the queue is full, True if not.
    ...
    def append(self, event, force = False):
        ...
        @return: None if appended successfully, or a matcher to match a QueueCanWriteEvent otherwise
        '''
    ...
    def waitForEmpty(self):
        ...
        @return: matcher for QueueIsEmptyEvent, or None if the queue is already empty
        '''
        if not self:
            return None
    ...
    def notifyAppend(self, queue, force):
        ...
        @return: If the append is blocked by parent, an EventMatcher is returned, None else.
        '''
        if not force and not self.canAppend():
            self.isWaited = True
            return QueueCanWriteEvent.createMatcher(self)
    ...
    def notifyPop(self, queue, length = 1):
        ...
        @return: List of any events generated by this pop
        '''
        self.totalSize = self.totalSize - length
        ret1 = []
        ret2 = []
    ...
    def canPop(self):
        ...
        @return: False if the queue is empty or blocked, or True otherwise
        '''
    ...
    def pop(self):
        ...
        @return: (obj, (queueEvents,...), (queueEmptyEvents,...)) where obj is the popped event, queueEvents are QueueCanWriteEvents generated by this pop
    ...
    def clear(self):
        ...
        @return: ((queueEvents,...), (queueEmptyEvents,...)) where queueEvents are QueueCanWriteEvents generated by clearing.
        '''
        l = len(self)
        ret = self._clear()
        if self.parent is not None:
    ...
    def removeSubQueue(self, queue):
        ...
        @return: ((queueevents,...), (queueEmptyEvents,...)) Possible queue events from removing sub-queues
        '''
        q = self.queueindex[queue]
        q[1].unblockall()
        q[1]._removeFromTree()
