...
from .common import *
from . import common
from protocol.openflow.defs.common import ofp_msg, ofp_error_typedef
from utils.namedstruct import sizefromlen, packsize
from protocol.openflow.defs.openflow13 import OFP_VERSION, ofp_error_type
'''
